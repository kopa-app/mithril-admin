...
module.exports = function (app, options) {
  ...
  factory.remove = require('./remove')(app);
  ...
  factory.load = function (resource, query) {
    return app.request({
      method: 'GET',
  ...
  factory.save = function (resource, item) {
    return app.request({
      method: 'PUT',
  ...
  factory.create = function (resource, item) {
    return app.request({
      method: 'POST',
  ...
  factory.remove = function (resource, item) {
    return app.request({
      method: 'DELETE',
      url: resource.restUrlFor(resource.id(item))
    }, {resource: resource, item: item});
