...
module.exports = function (app, options) {
  function factory(name, opts) {
    ...
    var resource = {
      ...
      sortBy: opts.sortBy || options.sortBy || null,
      sortDir: opts.sortDir || options.sortDir || 'asc',
    ...
    // create own methods
    resource.adminUrlFor = _.bind(opts.adminUrlFor || options.adminUrlFor || factory.adminUrlFor, null, resource);
    resource.restUrlFor = _.bind(opts.restUrlFor || options.restUrlFor || factory.restUrlFor, null, resource);
