...
var c = module.exports = {
  ...
  controller: function (context) {
    ...
    scope.toggleEditing = function (event) {
      ...
      scope.state = scope.state === 'editing' ? null : 'editing';
    };

    scope.toggleShowing = function (event) {
      event.preventDefault();
      scope.state = scope.state ? null : 'showing';
    };
  ...
  view: function (scope, context, opts) {
    ...
    var childContext = _.clone(context);
    childContext.action = scope.state === 'editing' ? 'edit' : (scope.state === 'showing' ? 'show' : context.action);
